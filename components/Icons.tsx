...
export const RobinhoodIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M15.65,12,12,16.48,8.35,12,12,7.52Zm.71-.71-4.37,4.37a.48.48,0,0,1-.7,0L7.64,11.29a.48.48,0,0,1,0-.7L11.65,6.2a.48.48,0,0,1,.7,0l4,4a.48.48,0,0,1,0,.7Z" />
    </svg>
);

export const MetaMaskIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12,2,2,7v10l10,5,10-5V7Zm7.6,6.8-5.4,3.1-2.2,1.3-2.2-1.3-5.4-3.1,5.4-3.1,2.2-1.3,2.2,1.3Z" />
    </svg>
);
...
export const ChipIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5M19.5 8.25H21M19.5 12H21M19.5 15.75H21M15.75 21v-1.5M12 5.25v-1.5m0 15v1.5m-2.25-8.25a2.25 2.25 0 012.25-2.25h.008a2.25 2.25 0 012.25 2.25v.008a2.25 2.25 0 01-2.25 2.25h-.008a2.25 2.25 0 01-2.25-2.25v-.008z" />
    </svg>
);

export const CashAppIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M14.68 16.23v-1.42c.96-.28 1.68-.93 1.68-1.92 0-.9-.59-1.55-1.57-1.84l-2.32-.67c-.63-.18-1.07-.6-1.07-1.2 0-.66.57-1.15 1.4-1.15.82 0 1.34.43 1.34 1.15v1.42c-.96.28-1.68.93-1.68 1.92 0 .9.59 1.55 1.57 1.84l2.32.67c.63.18 1.07.6 1.07 1.2 0-.66-.57-1.15-1.4-1.15-.82 0-1.34-.43-1.34-1.15zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-8.5c0-1.93 1.57-3.5 3.5-3.5 1.28 0 2.4.69 3 1.74V7h2v5.5c0 1.93-1.57 3.5-3.5 3.5-1.28 0-2.4-.69-3-1.74V17H7v-5.5z" />
    </svg>
);

export const VenmoIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.87 3.24L10.2 14.86c-.08.34.14.68.49.77l2.13.56c.35.09.69-.13.78-.48l2.67-11.64c.08-.34-.14-.68-.49-.77l-2.13-.56c-.35-.09-.69.13-.78.48zM9.31 8.87l-2.67 5.09c-.19.36.07.8.48.8h2.02c.36 0 .68-.25.78-.6L12.7 3.51c.14-.61-.59-1.03-1.12-.64L3.83 7.82c-.37.27-.47.79-.23 1.18l2.45 3.96c.24.39.76.5 1.13.23l1.83-1.34c.37-.27.87-.14 1.1.22z" />
    </svg>
);

export const PayPalIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M10.15 10.04c.14-1.45.86-2.58 2.29-2.58 1.43 0 2.15 1.13 2.01 2.58-.13 1.35-.93 2.45-2.22 2.45-1.36 0-2.06-1.1-2.08-2.45zm5.78-2.65c-.47-1.75-2.1-2.88-4.12-2.88H8.86c-.53 0-.91.33-1.05.86L5.3 16.92c-.08.3.15.58.46.58h2.95c.42 0 .76-.3.82-.72l.37-2.31c.21.13.43.24.67.33l.23.09c.87.33 1.83.42 2.82.22 2.24-.46 3.65-2.42 4.12-4.51.27-1.18.2-2.34-.33-3.32zM12.92 12.3c-.22.9-1.04 1.54-2.03 1.54-.92 0-1.68-.56-1.87-1.46-.2-.9.46-1.9 1.45-1.9.96 0 1.77.65 1.95 1.58.04.22.05.44.05.62v.02z" />
    </svg>
);

export const CurrencyDollarIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.21 12.768 11 12 11c-.768 0-1.536.21-2.218.659-.682.449-.682 1.63 0 2.079l.879.659M7.5 14.25l.879.659a3.375 3.375 0 004.242 0l.879-.659M16.5 10.5l-.879.659a3.375 3.375 0 01-4.242 0l-.879-.659" />
    </svg>
);
...
export const FileSearchIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25a3.375 3.375 0 10-6.75 0 3.375 3.375 0 006.75 0z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 19.5l-2.25-2.25" />
    </svg>
);
